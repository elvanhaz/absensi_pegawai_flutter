...
class _CurrentLocationScreenState extends State<ClockInView> {
  LatLng? currentLatLng;
  final pageC = Get.find<ClockInController>();

  ClockInController controller = Get.put(ClockInController());
                      ...
                      child: Container(
                        child: GoogleMap(
                          ...
                          initialCameraPosition: CameraPosition(
                              target: currentLatLng!, zoom: 17.0),
                        ),
                      ),
                    );
                  }),
      ...
      bottomNavigationBar: Container(
        ...
        child: Obx(
          () => ElevatedButton(
            ...
            child: Text(
              (controller.isLoading.isFalse) ? "Clock-In" : 'Loading...',
              style: TextStyle(
                fontSize: 16,
                fontFamily: 'poppins',
              ),
